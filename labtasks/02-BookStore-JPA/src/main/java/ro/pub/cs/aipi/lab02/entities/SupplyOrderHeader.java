...
public class SupplyOrderHeader extends PersistentEntity {
	...
	public SupplyOrderHeader(String identificationNumber, LocalDateTime issueDate, String state,
			PublishingHouse publishingHouse, Set<SupplyOrderLine> supplyOrderLines) {
