...
public class Exercise03Test {
	...
	final private static String persistentEntity = "User";
	...
	public void checkNumberOfRecords() {
		...
		assertEquals("Table user should have " + (TABLE_NUMBER_OF_RECORDS + 1) + " records!", (TABLE_NUMBER_OF_RECORDS + 1),
				(new PersistentEntityManager<User>(User.class, persistentEntity)).getPersistentEntitySize());
